...
//@PactBroker( host = "https://sm.pact.dius.com.au/", port = "443")
@PactBroker
//(host = "${pactbroker.url:'https://sm.pact.dius.com.au/'}", port = "443")
...
public class Product1BrokerTest {
	 ...
	 * 
	 *  @BeforeClass // // public static void start() { // // applicationContext =
	 * SpringApplication.run(EcommerceApplication.class); // // }
	 * 
	 *  @TargetRequestFilter // // public void printTheRequestHeaders(HttpRequest
	 * request) { // // Arrays.asList(request.getAllHeaders()) // // .forEach(header
